 ...
 */
@Slf4j
class MockRestAuthenticationFilter extends GenericFilterBean {
        ...
        if (true) {
			...
			println "................................adssfadsfdf"
                ...
                try {
					...
					authenticationResult = new UsernamePasswordAuthenticationToken(authenticationRequest.principal, authenticationRequest.credentials, authorities)
