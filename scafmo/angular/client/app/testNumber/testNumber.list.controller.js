...
angular.module('angularDemoApp')
	.controller('TestNumberListController', function ($scope, $rootScope,
		$state, $q, TestNumberService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					TestNumberService.query(query, function(response, responseHeaders){
