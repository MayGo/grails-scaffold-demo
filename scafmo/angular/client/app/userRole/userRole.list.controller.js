...
angular.module('angularDemoApp')
	.controller('UserRoleListController', function ($scope, $rootScope,
		$state, $q, UserRoleService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					UserRoleService.query(query, function(response, responseHeaders){
