...
angular.module('angularDemoApp')
  .service('TaskService', function($resource, $translate, appConfig, inform){
  		var service = {};
  		
  		var resource = $resource(appConfig.restUrl + '/tasks/v1/:id', { id: '@id' }, {
		...
		service.deleteInstance = function(instance) {
			return instance.$delete(
				function(instance) {
					$translate('pages.Task.messages.delete').then(function (msg) {
