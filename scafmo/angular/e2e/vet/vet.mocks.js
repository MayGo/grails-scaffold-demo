module.exports = function(){
	angular.module('httpBackendMock', ['ngMockE2E'])
		.run(function($httpBackend, appConfig) {
			console.log("running module vetHttpBackendMock")
			function quote(str) {
				return str.replace(/(?=[\/\\^$*+?.()|{}[\]])/g, "\\");
			}

			var url = appConfig.restUrl + '/vets/v1';
			...
			var specialitiesUrl =/.*\/specialitys\/v1.*/;
			$httpBackend.whenGET(specialitiesUrl).respond(function(method, url){return [200, [{'id': '1','name': 'Speciality 152'}]]});//list
