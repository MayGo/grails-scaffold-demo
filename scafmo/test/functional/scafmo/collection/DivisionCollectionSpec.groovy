...
class DivisionCollectionSpec extends RestQueries implements TestUtils{
	...
	def setupSpec() {
		...
		REST_URL = "${APP_URL}/divisioncollections/v1"
	}
	...
	void 'Using DivisionCollection list max property.'() {
		given:
	...
	void 'Excluding "ID" field in DivisionCollection list.'() {
	...
	void 'Including "ID" in DivisionCollection list.'() {
		when: 'Get divisionCollection sorted list'
	...
	@Unroll("DivisionCollection list search with props '#filter' returns '#respSize' items")
	void 'Filtering in DivisionCollection list by all properties.'() {
		given:
