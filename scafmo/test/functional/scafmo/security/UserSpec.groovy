...
class UserSpec extends RestQueries implements TestUtils{
	...
	void 'Using User list max property.'() {
		given:
	...
	void 'Excluding "ID" field in User list.'() {
	...
	void 'Including "ID" in User list.'() {
		when: 'Get user sorted list'
