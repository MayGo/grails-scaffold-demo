...
angular.module('angularDemoApp')
	.controller('PersonCollectionlessListController', function ($scope, $q, PersonCollectionlessService, $translate, inform) {
	...
	$scope.callServer = function (tableState) {
		...
		if(!$scope.skipFirstQueryInEmbeddedView ){
			PersonCollectionlessService.query(query, function(response, responseHeaders){
				$scope.isLoading = false;
...
angular.module('angularDemoApp')
	.controller('PersonCollectionlessEmbeddedListController', function ($scope) {
