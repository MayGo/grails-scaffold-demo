...
angular.module('angularDemoApp')
  .service('DivisionCollectionlessService', function($resource, $translate, appConfig, logger){
  		var service = {};
  		
  		var resource = $resource(appConfig.restUrl + '/divisioncollectionlesss/v1/:id', { id: '@id' }, {
