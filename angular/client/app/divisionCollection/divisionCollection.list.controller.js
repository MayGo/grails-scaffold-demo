...
angular.module('angularDemoApp')
	.controller('DivisionCollectionListController', function ($scope, $q, DivisionCollectionService, $translate, inform) {
	...
	$scope.callServer = function (tableState) {
		...
		if(!$scope.skipFirstQueryInEmbeddedView ){
			DivisionCollectionService.query(query, function(response, responseHeaders){
				$scope.isLoading = false;
...
angular.module('angularDemoApp')
	.controller('DivisionCollectionEmbeddedListController', function ($scope) {
