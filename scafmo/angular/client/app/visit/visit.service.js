...
angular.module('angularDemoApp')
  .service('VisitService', function($resource, $translate, appConfig, inform){
  		var service = {};
  		
  		var resource = $resource(appConfig.restUrl + '/visits/v1/:id', { id: '@id' }, {
		...
		service.deleteInstance = function(instance) {
			return instance.$delete(
				function(instance) {
					$translate('pages.visit.messages.delete').then(function (msg) {
