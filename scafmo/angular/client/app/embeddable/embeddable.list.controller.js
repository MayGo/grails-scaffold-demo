...
angular.module('angularDemoApp')
	.controller('EmbeddableListController', function ($scope, $rootScope,
		$state, $q, EmbeddableService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					EmbeddableService.query(query, function(response, responseHeaders){
