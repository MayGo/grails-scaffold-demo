...
class PetSpec extends RestQueries implements TestUtils{
	...
	void 'Using Pet list max property.'() {
		given:
	...
	void 'Excluding "ID" field in Pet list.'() {
