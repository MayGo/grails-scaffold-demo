...
angular.module('angularDemoApp')
	.controller('PetListController', function ($scope, $rootScope,
		$state, $q, PetService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					PetService.query(query, function(response, responseHeaders){
