...
describe('Service: TestStringService', function () {
  ...
  it('query() should respond', function () {
  	...
  	httpBackend.whenGET(config.restUrl + 'teststrings').respond([{"id":1},{"id":2}]);
  ...
  it('get() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenGET(config.restUrl + 'teststrings/1').respond({"id":1});
  ...
  it('update() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPUT(config.restUrl + 'teststrings/1').respond({"id":1});
  ...
  it('save() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPOST(config.restUrl + 'teststrings').respond({"id":1});
