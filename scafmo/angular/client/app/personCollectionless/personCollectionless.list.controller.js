...
angular.module('angularDemoApp')
	.controller('PersonCollectionlessListController', function ($scope, $rootScope,
		$state, $q, PersonCollectionlessService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
