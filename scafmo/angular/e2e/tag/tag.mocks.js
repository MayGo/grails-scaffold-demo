module.exports = function(){
	angular.module('httpBackendMock', ['ngMockE2E'])
		.run(function($httpBackend, appConfig) {
			console.log("running module tagHttpBackendMock")
			function quote(str) {
			...
			var tasksUrl =/.*\/tasks\/v1.*/;
			$httpBackend.whenGET(tasksUrl).respond(function(method, url){return [200, [{'id': '1','timeSpent': '0','summary': 'Work Summary 152','status': 'Open'}]]});//list
