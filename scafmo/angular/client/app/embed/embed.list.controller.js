...
angular.module('angularDemoApp')
	.controller('EmbedListController', function ($scope, $rootScope,
		$state, $q, EmbedService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					EmbedService.query(query, function(response, responseHeaders){
