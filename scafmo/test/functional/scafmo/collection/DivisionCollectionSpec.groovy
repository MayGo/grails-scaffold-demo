...
class DivisionCollectionSpec extends Specification implements RestQueries, AuthQueries, TestUtils{
	...
	@Unroll("DivisionCollection list search with props '#jsonVal' returns '#respSize' items")
