...
angular.module('angularDemoApp')
	.controller('ClassifierListController', function ($scope, $rootScope,
		$state, $q, ClassifierService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
