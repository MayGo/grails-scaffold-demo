...
class TagSpec extends RestQueries implements TestUtils{
	...
	void 'Using Tag list max property.'() {
		given:
	...
	void 'Excluding "ID" field in Tag list.'() {
