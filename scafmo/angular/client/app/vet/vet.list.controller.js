...
angular.module('angularDemoApp')
	.controller('VetListController', function ($scope, $rootScope,
		$state, $q, VetService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					VetService.query(query, function(response, responseHeaders){
