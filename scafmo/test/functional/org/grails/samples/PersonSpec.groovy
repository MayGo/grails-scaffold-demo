...
class PersonSpec extends Specification implements RestQueries, AuthQueries, TestUtils{
	...
	@Unroll("Person list search with props '#jsonVal' returns '#respSize' items")
