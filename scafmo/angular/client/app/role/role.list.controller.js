...
angular.module('angularDemoApp')
	.controller('RoleListController', function ($scope, $rootScope,
		$state, $q, RoleService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					RoleService.query(query, function(response, responseHeaders){
