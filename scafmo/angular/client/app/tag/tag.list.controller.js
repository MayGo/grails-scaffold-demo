...
angular.module('angularDemoApp')
	.controller('TagListController', function ($scope, $rootScope,
		$state, $q, TagService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					TagService.query(query, function(response, responseHeaders){
