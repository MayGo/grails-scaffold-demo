...
angular.module('angularDemoApp')
	.controller('VisitListController', function ($scope, $rootScope,
		$state, $q, VisitService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					VisitService.query(query, function(response, responseHeaders){
