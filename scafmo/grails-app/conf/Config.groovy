	...
	plugin{
		scaffold{
			core{
				...
				displayNames = ['Tag':['id', 'name'], 'Task':['id', 'deadline', 'details', 'status'], 'Owner':['id', 'address', 'city', 'firstName'], 'Person':['id', 'firstName', 'lastName'], 'Pet':['id', 'birthDate', 'name'], 'PetType':['id', 'name'], 'Speciality':['id', 'name'], 'Vet':['id', 'firstName', 'lastName'], 'Visit':['id', 'date', 'description'], 'DivisionCollection':['id', 'name'], 'DivisionCollectionless':['id', 'name'], 'PersonCollection':['id', 'age', 'name'], 'PersonCollectionless':['id', 'age', 'name'], 'TestNumber':['id', 'doubleNr', 'floatNr', 'floatNrScale'], 'TestOther':['id', 'booleanNullable', 'testDate', 'testEnum'], 'TestString':['id', 'blankStr', 'creditCardStr', 'emailStr'], 'Role':['id', 'authority'], 'User':['id', 'accountExpired', 'accountLocked', 'enabled'], 'UserRole':['id'], 'Classifier':['id', 'classname', 'constant', 'description']]
			}
		}
	}
}
...
security.casURL = 'http://cas.dwl.smit'
/**
 * LDAP config
 */

/* for LdapService class usage -*/
ldap.managerDn = 'svc_ldap_dwl'
ldap.managerPassword = 'cHAbRajer6m7cHedujaf'
ldap.server = 'ldap://ms-ad-f5.smit:389'


//FUNCTIONAL TESTING
environments {
	test {
		functionalTest.userName = '30101010105'
		functionalTest.password = 'Muusika123'
	}
}
