...
angular.module('angularDemoApp')
	.controller('PersonCollectionListController', function ($scope, $rootScope,
		$state, $q, PersonCollectionService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					PersonCollectionService.query(query, function(response, responseHeaders){
