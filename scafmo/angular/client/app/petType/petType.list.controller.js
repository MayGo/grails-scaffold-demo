...
angular.module('angularDemoApp')
	.controller('PetTypeListController', function ($scope, $rootScope,
		$state, $q, PetTypeService, $stateParams, $timeout, logger, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					PetTypeService.query(query, function(response, responseHeaders){
