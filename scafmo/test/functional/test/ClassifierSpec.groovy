...
class ClassifierSpec extends RestQueries implements TestUtils{
	...
	def setupSpec() {
		...
		REST_URL = "${APP_URL}/classifiers/v1"
	}
	...
	void 'Using Classifier list max property.'() {
		given:
	...
	void 'Excluding "ID" field in Classifier list.'() {
	...
	void 'Including "ID" in Classifier list.'() {
		when: 'Get classifier sorted list'
