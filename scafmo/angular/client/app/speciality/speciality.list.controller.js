...
angular.module('angularDemoApp')
	.controller('SpecialityListController', function ($scope, $rootScope,
		$state, $q, SpecialityService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
