...
angular.module('angularDemoApp')
    .controller('PersonCollectionlessEditController', function ($scope, $state, $q, $stateParams, PersonCollectionlessService, personCollectionlessData, $translate, logger ) {
