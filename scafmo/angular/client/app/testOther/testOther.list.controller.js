...
angular.module('angularDemoApp')
	.controller('TestOtherListController', function ($scope, $rootScope,
		$state, $q, TestOtherService, $stateParams, $timeout, inform, ngTableParams, appConfig, $location, $mdDialog) {
		...
		var settings = {
			getData: function($defer, params) {
				...
				filterTimeout = $timeout(function() {
					...
					TestOtherService.query(query, function(response, responseHeaders){
