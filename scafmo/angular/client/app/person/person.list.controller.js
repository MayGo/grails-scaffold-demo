...
angular.module('angularDemoApp')
	.controller('PersonListController', function ($scope, $q, PersonService, $translate, inform) {
	...
	$scope.callServer = function (tableState) {
		...
		if(!$scope.skipFirstQueryInEmbeddedView ){
			PersonService.query(query, function(response, responseHeaders){
				$scope.isLoading = false;
...
angular.module('angularDemoApp')
	.controller('PersonEmbeddedListController', function ($scope) {
