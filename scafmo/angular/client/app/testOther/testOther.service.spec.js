...
describe('Service: TestOtherService', function () {
  ...
  var httpBackend;
  var config;
  beforeEach(inject(function (_TestOtherService_, $httpBackend, appConfig) {
    service = _TestOtherService_;
  ...
  it('query() should respond', function () {
  	...
  	httpBackend.whenGET(config.restUrl + '/testothers/v1').respond([{"id":1},{"id":2}]);
  ...
  it('get() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenGET(config.restUrl + '/testothers/v1/1').respond({"id":1});
  ...
  it('update() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPUT(config.restUrl + '/testothers/v1/1').respond({"id":1});
  ...
  it('save() should respond', function () {
  	httpBackend.whenGET('l10n/en.js').respond();
  	httpBackend.whenPOST(config.restUrl + '/testothers/v1').respond({"id":1});
